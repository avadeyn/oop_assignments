...
class Program
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine($"Model: {myCar.Model}, Make: {myCar.Make}, Year: {myCar.Year}"); // encapsulated 
        Console.WriteLine($"Model: {NadsCar.Model}, Make: {NadsCar.Make}, Year: {NadsCar.Year}, Price: {NadsCar.Price}");
        Console.WriteLine($"Model: {newElectric.Model}, Make: {newElectric.Make}, Year: {newElectric.Year}, Price: {newElectric.Price}, Charging Time: {newElectric.Time}");
